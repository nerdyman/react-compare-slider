...
export const Images: StoryObj = (props) => (
  <ReactCompareSlider
    {...props}
    itemOne={
...
export const BoundsPadding: StoryObj = ({ boundsPadding = 80, ...props }) => {
  return (
...
export const OnPositionChange: StoryObj = (props) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
      <div className="sb-custom-note">
        <em>Note:</em> This demo will be slightly laggy when viewing the action logging output.
      </div>
...
export const OnlyHandleDraggable: StoryObj = ({ onlyHandleDraggable = true, ...props }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
      <ReactCompareSlider
        {...props}
...
export const Portrait: StoryObj = ({ portrait = true, ...props }) => (
  <ReactCompareSlider
    portrait={portrait}
    itemOne={
      <ReactCompareSliderImage
...
export const Position: StoryObj = ({ position = 75, ...props }) => (
  <ReactCompareSlider
    position={position}
    itemOne={
      <ReactCompareSliderImage
...
export const ChangePositionOnHover: StoryObj = ({ changePositionOnHover = true, ...props }) => {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
      <ReactCompareSlider
        {...props}
